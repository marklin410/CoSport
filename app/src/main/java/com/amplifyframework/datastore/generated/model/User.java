...
public final class User implements Model {
  ...
  public static final QueryField SURNAME = field("User", "surname");
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), user.getId()) &&
              ...
              ObjectsCompat.equals(getSurname(), user.getSurname()) &&
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String surname) {
      super.id(id);
      super.name(name)
        .surname(surname);
    }
